    ...
    <div class="container">
        <div class="form-container">
            <div class="button-container">
                <button class="btn" onclick="window.location.href='order/order_add.php'">Order Add</button>
                <button class="btn" onclick="window.location.href='inventory/inventory_select.php'">Order To Inventory</button>
                <button class="btn" onclick="window.location.href='order/order_view.php'">Order View</button>
                <button class="btn" onclick="window.location.href='order_inventory/o_i_view.php'">Order Contribution Report</button>
            </div>
        </div>
    </div>
