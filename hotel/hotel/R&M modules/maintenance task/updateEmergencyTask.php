...
if (isset($_REQUEST['task_id'])) {
    ...
    if (!$task) {
        ...
        // Restriction: Prevent updates if the task is approved
        if (strtolower($task['task_status']) === 'completed') {
            echo "<script>
                alert('This task has already been completed and cannot be updated.');
...
<head>
    ...
    <title>Update Emergency Maintenance Task</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h2>Update Emergency Maintenance Task</h2>

        <!-- Task Details -->
        <div class="mb-3">
            <label class="form-label">Task ID:</label>
            <p class="form-control-plaintext"><?php echo $task_id; ?></p>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <p class="form-control-plaintext"><?php echo $assigned_staff['staff_firstname'] . ' ' . $assigned_staff['staff_lastname']; ?></p>
        </div>
        <div class="mb-3">
            <label class="form-label">Maintenance Type:</label>
            <p class="form-control-plaintext"><?php echo $main_type; ?></p>
        </div>
        <div class="mb-3">
            <label class="form-label">Task Description:</label>
            <p class="form-control-plaintext"><?php echo htmlspecialchars($task['task_desc']); ?></p>
        </div>
